...
export default function SignUpPage(){
    ...
    <div style={{width: 830, height: 75, left: 369, top: 220, position: 'absolute', textAlign: 'center', color: '#EFC983', fontSize: 32, fontFamily: 'Laila', fontWeight: '700', letterSpacing: 1.44, wordWrap: 'break-word'}}>To sign up please enter your user information below</div>
