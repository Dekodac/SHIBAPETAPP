...
<div style={{width: 1512, height: 982, position: 'relative', background: '#BEB378'}}>
  ...
  <img style={{ width: '216px', height: '189px', left: '648px', top: '491px', position: 'absolute', borderRadius: '170px', border: '0.50px black solid' }} src={evaSanchezPurpleShibabueno} alt="ShibaGif" />
